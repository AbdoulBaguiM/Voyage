...
const Appartement = () => {
  ...
  const fetchAppartement = () => {
    api.get(`/appartements/${id}`).then(res => {
  ...
  const updateAppartement = async(e) => {
    e.preventDefault();
    ...
    await api.put('/appartements/' + id, {...appartement})
              ...
              >
                ...
                >
                  <TextField
                    ...
                    value={appartement.ascenseur==1 ? 1 : 0}
                    variant="outlined"
                  />
                </Grid>
                <Grid
                ...
                >
                  <TextField
                    ...
                    inputProps={{ min: "0", max: "1", step: "1" }}
                    onChange={handleChange}
                    value={appartement.agentSecurite==1 ? 1 : 0}
